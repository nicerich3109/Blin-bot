...
GUILD_ID = 1372267300366979223  # Blin Dynasty
...
# Задержка перед удалением обработанной заявки.
# После принятия/отклонения канал остаётся доступен 10 минут, затем удаляется.
TICKET_DELETE_DELAY_SECONDS = 600
