...
# Панель с кнопками контрактов. По умолчанию используется тот же канал,
# куда приходят заявки; при необходимости укажите другой ID.
...
CONTRACT_PANEL_IMAGES = {"PHX": "", "DN": ""}
# Не более 20 кнопок на сервер. У каждой кнопки не более 10 опций,
# у каждой опции не более 5 строк модального окна.
CONTRACT_BUTTONS = {
    "PHX": [
        {"key":"contract_1","label":"Контракт 1","style":"primary","options":[
            {"value":"option_1","label":"Выплата","modal_title":"Заявка на выплату",
             "fields":[
                {"label":"Номер контракта","placeholder":"Укажите номер","required":True},
                {"label":"Что выполнено","placeholder":"Опишите выполненный контракт","paragraph":True,"required":True}
             ]}
        ]}
    ],
    "DN": [
...
# mode = "reaction" или "button". Для reaction задаётся emoji -> role_id.
# Для button можно задать максимум 2 кнопки в одном сообщении.
REACTION_ROLE_MESSAGES = {
    ...
    #     "image": "",
    #     "mode": "button",
    #     "buttons": [{"label":"Получить роль","role_id":123,"style":"success"}],
    #     "role_id_by_emoji": {"✅": 123},
    # }
}
